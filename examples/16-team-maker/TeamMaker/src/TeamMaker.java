...
//        playersList.add("Boyan Dimitrov");
//        playersList.add("Diliyan Dimitrov");
//        playersList.add("Dimitar Draganov");
//        playersList.add("Gergana Georgieva");
//        playersList.add("Hristo Lihov");
//        playersList.add("Mariana Angelova");
//        playersList.add("Mila Ivanova");
//        playersList.add("Mila Mileva");
//        playersList.add("Milen Pishimarov");
//        playersList.add("Nikolay Bonev");
//        playersList.add("Tatiyana Gancheva");
//        playersList.add("Valentina Bayraktarova");
//        playersList.add("Yoanna Vasileva");
